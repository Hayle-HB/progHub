           ...
           <div className="relative flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-12">
             ...
             <div className="flex-1 text-center lg:text-left space-y-4 sm:space-y-6">
               ...
               <div className="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4">
                 <Link 
                   to="/core" 
                   className="px-4 sm:px-6 py-2.5 sm:py-3 bg-[#4ADE80] text-[#1E293B] rounded-lg font-medium hover:bg-[#4ADE80]/90 transition-colors text-sm sm:text-base"
                 >
                   Get Started
                 </Link>
                 <Link 
                   to="/about" 
                   className="px-4 sm:px-6 py-2.5 sm:py-3 border border-[#4ADE80] text-[#4ADE80] rounded-lg font-medium hover:bg-[#4ADE80]/10 transition-colors text-sm sm:text-base"
                 >
                   Learn More
                 </Link>
               </div>
